...
function the_widgets_init() {
	...
	// Homepage Columns
	register_sidebar(array( 'name' => __( 'Homepage Columns - Left', 'woothemes' ),'id' => 'homepage-columns-left','description' => __( 'Homepage Columns Left.', 'woothemes' ), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
	register_sidebar(array( 'name' => __( 'Homepage Columns - Right', 'woothemes' ),'id' => 'homepage-columns-right','description' => __( 'Homepage Columns Right.', 'woothemes' ), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
